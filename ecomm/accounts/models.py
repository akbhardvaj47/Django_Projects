...
class Cart(BaseModel):
    ...
    def get_cart_total(self):
        ...
        if self.coupon:
            if self.coupon.minimum_order < sum(price):
...
def create_profile_and_send_email_token(sender, instance, created, **kwargs):
    try:
        if created:
            print("User created, sending activation email...")
            # Generate and assign email token
